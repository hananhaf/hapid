...
const ProductDetails3 = () => {
  ...
  return (
    <View style={[styles.productDetails3, styles.iconLayout]}>
      <ImageBackground
        style={styles.productDetails3Child}
        resizeMode="cover"
        source={require("../assets/rectangle12.png")}
      />
      <Text style={[styles.nikeAir2, styles.nikeAir2Typo]}>Nike Air 2</Text>
      <Text style={[styles.rp2000000, styles.sizeUkTypo, styles.nikeAir2Typo]}>
        Rp. 2.000.000
      </Text>
      ...
      />
      <Image
        style={[styles.productDetails3Child2, styles.productChildLayout]}
        resizeMode="cover"
